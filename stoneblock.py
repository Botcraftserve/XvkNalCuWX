...
paczka = 'https://media.forgecdn.net/files/3016/966/stoneblock_1.0.37-server.zip'
...
r = s.post('https://craftserve.pl/s/' + sid + '/files_unzip/stoneblock_1.0.37-server.zip', {'destination': '/'})
time.sleep(10)
r = s.delete(strona + 'stoneblock_1.0.37-server.zip')
